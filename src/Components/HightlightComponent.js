...
const HightlightCard = (props) => {
  return (
    <div className="hightlightDiv-card">
      ...
      <h1 className="hightlightDiv-card-number">
        {props.number}
        {props.sufix}
      </h1>
    </div>
...
const HightlightComponent = (props) => {
  ...
  return (
    <div className="hightlightsDiv">
      ...
      <div className="hightlightInner-div">
        <HightlightCard
          text="Wind status"
          number={dataForHightlight.defaultData.current.wind_mph}
          sufix=" mph"
        />
        <HightlightCard
          text="Humidity"
          number={dataForHightlight.defaultData.current.humidity}
          sufix="%"
        />
        <HightlightCard
          text="Visibility"
          number={dataForHightlight.defaultData.current.vis_miles}
          sufix=" miles"
        />
        <HightlightCard
          text="Air Pressure"
          number={dataForHightlight.defaultData.current.pressure_mb}
          sufix=" mb"
        />
      </div>
    </div>
